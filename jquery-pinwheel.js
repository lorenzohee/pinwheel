/**
 * Created by Lorenzo on 2016/2/18.
 */
/*!
 ...
 * @author         charles.yu
 * @documentation
 * @modify by			 lorenzo hee at 2016-2-18
 *
 * ------------------------------------------------------------------
 *
 *  <div id="tip"></div>
...
(function($){
	var $loading, $wrap, timers = [], optsArray = [], currentObj, currentOpts = {},
		...
		_appendContent = function(){
			...
			//change loading style to awesome font http://fontawesome.io/icons
			$loading = $('<div class="pinwheel_loading"><div>Loading...</div></div>');
			...
			switch (type) {
				...
				case 'ajax' :
					...
					if($(currentObj).attr('data-remote')){
		...
		return this.each(function(){
			...
			$(this).bind("mouseover",function(e){
				...
				if(currentObj && currentObj == this){
					...
					//为什么要全部解除绑定呢？这样其他的绑定就无效了，改为只解除mouseover的绑定 ---2017-06-14 by lorenzoho
